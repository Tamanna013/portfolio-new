...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `/s2.png`, text: 'Chat-Application' },
      { image: `/Screenshot.png`, text: 'AnswerPol' },
      { image: `/globe.png`, text: '3D Globe Visualization' },
      { image: `password-generator.png`, text: 'Password Generator' },
      { image: `/wormhole.png`, text: '3D Wormhole' },
      { image: `/atoms.png`, text: 'Atoms' },
    ]
